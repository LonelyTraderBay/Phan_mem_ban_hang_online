...
Break-glass support access grants with reason/ticket/expiry/scope.
...
In scope: Support access grant model/API baseline.
...
See `docs/tickets/BE-IDN-test-matrix.md` row `BE-IDN-014`.
