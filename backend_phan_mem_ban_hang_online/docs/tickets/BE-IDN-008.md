...
TOTP enroll/verify, recovery codes, step-up recent-auth.
...
In scope: TOTP MFA/recovery codes/step-up.

Out of scope: unrelated modules; FE UI work (FE sync after BE contract freeze).

# Dependencies

Blocked on **BE-IDN-003**. Closes GAP-008 (typed MFA verify request body).
