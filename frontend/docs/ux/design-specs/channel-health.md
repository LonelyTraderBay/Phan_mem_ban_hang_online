# Design spec: `/channel-health` — Super Admin — Channel health (platform)

**Status:** READY-MOCK — HO defaults policy C (enterprise freeze W6) 2026-07-22
**Version:** v1 — 2026-07-22
**Author:** Design AI Agent
**Route:** `/channel-health`
**Required permission(s):** ops.channel.manage
**App:** super-admin
...
```text
Cross-tenant channel health rollup
...
- Platform rollup — do not expose tenant PII in aggregates.
- Sample chrome: `[DRAFT COPY]` titles as in layout sketch.

### Empty

- EmptyState: [DRAFT COPY] Không có tín hiệu kênh.
...
- Missing **ops.channel.manage**: full-page ForbiddenState via PermissionGate.
- Copy: `[DRAFT COPY] Bạn không có quyền xem channel health nền tảng.`
...
| Rollup table | **MISSING COMPONENT** | — |
