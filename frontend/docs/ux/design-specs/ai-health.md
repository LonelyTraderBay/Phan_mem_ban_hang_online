...
```text
Platform AI health panels + kill switch (ops.ai.disable)
...
- Kill switch is ops-only; show confirmation Modal.
- Sample chrome: `[DRAFT COPY]` titles as in layout sketch.

### Empty

- EmptyState: [DRAFT COPY] Chưa có tín hiệu health.
...
- Missing **ops AI**: full-page ForbiddenState via PermissionGate.
- Copy: `[DRAFT COPY] Bạn không có quyền xem AI health.`
...
| Health dashboard widgets | **MISSING COMPONENT** | — |
...
Disable AI → typed confirm → audit.
