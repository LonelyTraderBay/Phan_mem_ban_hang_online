---
ticket_id: BE-P0-010
title: Security/AI threat model P0
...
Security/AI threat model P0.

Deliverable / details from backlog: risks/mitigations/tests.

Primary paths: `docs/threat-model/p0-threat-model.md`.
