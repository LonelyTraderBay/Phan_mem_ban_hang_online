---
ticket_id: BE-FUL-001
title: Shipment/item/tracking/packing-slip data
...
Shipment/item/tracking/packing-slip data.
...
Actors and flows for domain **FUL** as defined in the enterprise blueprint and frozen OpenAPI/AsyncAPI contracts for this phase (P7).
...
- OpenAPI operation/schema: slice with `pnpm agent:contract-slice` for FUL; implement only operations this ticket owns.
