---
ticket_id: BE-P0-005
title: Permission matrix và default roles
...
Permission matrix và default roles.

Deliverable / details from backlog: CSV/seed plan.

Primary paths: `backend_doc/matrices/permission_matrix.csv`.
