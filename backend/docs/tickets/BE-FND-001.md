...
Deliverable / details from backlog: pnpm workspace, apps/packages/modules, strict TS, boundary lint.

Primary paths: `package.json;modules/;eslint.config.mjs`.
