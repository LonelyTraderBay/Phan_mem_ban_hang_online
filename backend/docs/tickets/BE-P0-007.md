---
ticket_id: BE-P0-007
title: OpenAPI/AsyncAPI skeleton + lint rules
...
OpenAPI/AsyncAPI skeleton + lint rules.

Deliverable / details from backlog: contracts compile.

Primary paths: `backend_doc/contracts/;packages/contracts-http/`.
