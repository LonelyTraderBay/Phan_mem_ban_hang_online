...
Deliverable / details from backlog: lint, docs, generated client/types/mock.

Primary paths: `tools/validate-contracts.mjs;packages/contracts-http/`.
