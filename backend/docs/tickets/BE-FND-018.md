---
ticket_id: BE-FND-018
title: test-utils invariant helpers
...
test-utils invariant helpers.

Deliverable / details from backlog: createTenantIsolationFixture/assertCrossTenantDenied/replayIdempotencyKey/money helpers.

Primary paths: `packages/test-utils/`.
