---
ticket_id: BE-P0-001
title: Xác nhận capacity/SLO/cost assumptions
...
Xác nhận capacity/SLO/cost assumptions.

Deliverable / details from backlog: NFR sign-off.

Primary paths: `docs/p0/capacity-slo-cost-assumptions.md`.
