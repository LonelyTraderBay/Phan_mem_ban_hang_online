---
ticket_id: BE-FND-011
title: Queue/scheduler skeleton
...
Deliverable / details from backlog: BullMQ queues, retry/lease/graceful shutdown.

Primary paths: `apps/worker/;apps/scheduler/`.
