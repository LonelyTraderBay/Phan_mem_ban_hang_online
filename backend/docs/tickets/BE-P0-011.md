---
ticket_id: BE-P0-011
title: Epic decomposition và dependency board
...
Epic decomposition và dependency board.

Deliverable / details from backlog: implementation-ready backlog.

Primary paths: `docs/p0/epic-dependency-board.md`.
