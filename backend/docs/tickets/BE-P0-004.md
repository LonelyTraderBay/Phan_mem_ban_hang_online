---
ticket_id: BE-P0-004
title: ERD v1 và table classification
...
ERD v1 và table classification.

Deliverable / details from backlog: ERD/data dictionary.

Primary paths: `docs/data/table-classification-seed.md`.
