---
ticket_id: BE-AI-008
title: Draft/reservation/message mutation tools with idempotency/approval
...
Draft/reservation/message mutation tools with idempotency/approval.

Deliverable / details from backlog: (none — expand from blueprint + contracts before coding).

Primary paths: `modules/ai-orchestration/;apps/ai-service/`.

# Actor and use case

Actors and flows for domain **AI** as defined in the enterprise blueprint and frozen OpenAPI/AsyncAPI contracts for this phase (P8).
...
- OpenAPI operation/schema: slice with `pnpm agent:contract-slice` for AI; implement only operations this ticket owns.
