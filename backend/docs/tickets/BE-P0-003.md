---
ticket_id: BE-P0-003
title: System context/data flow/trust boundary
...
System context/data flow/trust boundary.

Deliverable / details from backlog: diagrams + threat model seed.

Primary paths: `docs/diagrams/;docs/threat-model/`.
