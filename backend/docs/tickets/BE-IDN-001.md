---
ticket_id: BE-IDN-001
title: Create identity/tenant/membership/role/session/device schema + RLS
...
Land `000005_identity_schema.sql` per `docs/data/identity-migration-design.md`; RLS for all identity tables including nullable-tenant `user_sessions`.
...
- Schema matches data-dictionary classes
