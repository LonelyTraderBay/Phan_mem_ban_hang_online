---
ticket_id: BE-FND-010
title: Outbox/inbox component
...
Outbox/inbox component.

Deliverable / details from backlog: schema, publisher, consumer base, DLQ.

Primary paths: `packages/outbox/`.
