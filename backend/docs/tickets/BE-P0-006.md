---
ticket_id: BE-P0-006
title: State machine transition matrices
...
Deliverable / details from backlog: reviewed spec/tests outline.

Primary paths: `docs/domain/state-machine-transition-matrices.md`.
