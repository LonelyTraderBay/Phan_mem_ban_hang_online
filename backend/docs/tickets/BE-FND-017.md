---
ticket_id: BE-FND-017
title: Audit module reference tests
...
Audit module reference tests.

Deliverable / details from backlog: permission-negative + write-path/redaction on walking skeleton; full 5-category suite.

Primary paths: `modules/audit/`.
