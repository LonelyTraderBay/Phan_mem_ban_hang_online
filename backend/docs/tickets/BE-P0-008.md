---
ticket_id: BE-P0-008
title: Error/idempotency/audit/event catalogs
...
Error/idempotency/audit/event catalogs.

Deliverable / details from backlog: machine-readable catalogs.

Primary paths: `backend_doc/matrices/error_catalog.csv`.

# Actor and use case

Actors and flows for domain **GEN** as defined in the enterprise blueprint and frozen OpenAPI/AsyncAPI contracts for this phase (P0).
...
- OpenAPI operation/schema: slice with `pnpm agent:contract-slice` for GEN; implement only operations this ticket owns.
