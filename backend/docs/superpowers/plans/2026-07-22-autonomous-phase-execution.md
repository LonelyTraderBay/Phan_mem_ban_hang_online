...
### Wave 5 — P6 Conversation (chỉ khi Wave 4 exit)

12. [x] BE-CON-001 … BE-CON-012 conversation schema + in-memory application (`000018`)

### Wave 7 — P8 AI orchestration (chỉ khi Wave 6 exit)

13. [x] BE-AI-001 … BE-AI-016 AI schema + in-memory application + ai-service stub (`000021`)

### Wave 8+ — theo phase blueprint

P9 Analytics → P10 Billing → … → P11 Hardening  
